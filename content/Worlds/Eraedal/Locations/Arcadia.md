...
- **Orc:** 21,000 _(Historically integrated as free agrarian laborers and laborers)_
...
### 1. [[Wenglid Family Temple | The Wenglid Family Temple]]
...
- **Functional Utility:** Built to accommodate the wildly diverse religious practices of House Wenglid's 500+ family members, the temple is uniquely open to house slaves, servants, and common military units. To ground this in **Pathfinder 2e**, the traditional Palladium altars have been converted to their closest thematic Golarion equivalents:
  ...
  - **Aco & The Juggernaut** is represented via the enduring, steadfast domain of **[[Torag]]**.

  - **The Pantheon of Rurga** (Justice, War, and Honor) maps cleanly to the righteous fury of **[[Iomedae]]**.

  - **The Pantheon of Ra** (Sun, Light, and Life) is dedicated to the radiant grace of **[[Sarenrae]]**.
...
- **Pathfinder 2e Registry:** `Level 7 Human Cleric (Sarenrae)`
...
- **Pathfinder 2e Registry:** `Level 5 Human Expert Artisan (Occult/Divine Medium)`
...
- **Pathfinder 2e Registry:** `Level 4 Human Rogue (Scoundrel)`
...
- **Pathfinder 2e Registry:** `Level 5 Human Psychic (Gamble-Bound / Unbound Mind)`
